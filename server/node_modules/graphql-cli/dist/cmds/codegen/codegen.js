...
var getApolloCodegenBin_1 = require("./getApolloCodegenBin");
...
var Codegen = /** @class */ (function () {
    ...
    Codegen.prototype.codegen = function () {
        return __awaiter(this, void 0, void 0, function () {
            var codegenConfigs, _i, codegenConfigs_1, codegenConfig, output, input, generator, language, inputSchemaPath, binPath, tmpSchemaPath, _a, _b, _c, _d, _e, args, child, stderr, args, child, stderr;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        if (!(this.project.config.extensions &&
                            this.project.config.extensions.codegen)) return [3 /*break*/, 7];
                        ...
                        _f.label = 1;
                    case 1:
                        if (!(_i < codegenConfigs_1.length)) return [3 /*break*/, 6];
                        ...
                        if (!(generator === 'typegen')) return [3 /*break*/, 4];
                        inputSchemaPath = inputSchemaPath || '**/*.ts';
                        return [4 /*yield*/, getApolloCodegenBin_1.default()];
                    case 2:
                        binPath = _f.sent();
